...
def main() -> None:
	...
	payor_vendors_path = 'scripts/data/payor_vendors_2021_05_11.xlsx'
	with models.session_scope(session_maker) as session:
		companies.load_into_db_from_excel(session, payor_vendors_path)

	purchase_money_financing_all_path = 'scripts/data/pmf_all_2021_05_11.xlsx'
	with models.session_scope(session_maker) as session:
		print(f'Beginning import...')

		workbook, err = excel_reader.ExcelWorkbook.load_xlsx(purchase_money_financing_all_path)
		if err:
			raise Exception(err)
