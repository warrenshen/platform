...
def main() -> None:
	...
	payor_vendors_path = 'scripts/data/payor_vendors_2021_04_26.xlsx'
	with models.session_scope(session_maker) as session:
		companies.load_into_db_from_excel(session, payor_vendors_path)

	inventory_financing_all_path = 'scripts/data/inventory_financing_all_2021_04_26.xlsx'
	with models.session_scope(session_maker) as session:
		print(f'Beginning import...')

		workbook, err = excel_reader.ExcelWorkbook.load_xlsx(inventory_financing_all_path)
		if err:
			raise Exception(err)
