...
def verify_blaze_auth_payload(
	...
	# Developer note: print out hash_output if you want to view the correct value for auth_key.
	# hash_output = sha256.using(salt=str.encode(secret_key)).hash(hash_input)
