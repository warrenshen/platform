...
class Actions(object):
	...
	FINANCE_EDIT_ACCOUNT_LEVEL_FEE = 'finance_edit_account_level fee'
	...
	LOANS_EDIT_REPAYMENT_DATE = 'loans_edit_repayment_date'
	LOANS_EDIT_REPAYMENT_BANK_NOTE = 'loans_edit_repayment_bank_note'
	...
	LOANS_ARCHIVE_LOAN = 'loans_archive_loan'
	LOANS_UNARCHIVE_LOAN = 'loans_unarchiveloan'
