...
class CreateLoginView(MethodView):
	...
	def post(self) -> Response:
		...
		is_company_admin_for_your_company = user_session.get_company_id() == form['company_id'] and user_session.is_company_admin()
		...
		with session_scope(current_app.session_maker) as session:
			...
			existing_user.password = security_util.hash_password(cfg.PASSWORD_SALT, password)
