describe("Setup borrowing base", () => {
  ...
  it("Bank user can submit borrowing base on behalf of customer", () => {
    cy.loginBankAdmin();
    ...
    cy.dataCySelector("borrowing-base-modal-custom-amount-text", "input").type(
      "Cypress"
    );
  ...
  it("Bank user can edit borrowing base on behalf of customer", () => {
    cy.loginBankAdmin();
