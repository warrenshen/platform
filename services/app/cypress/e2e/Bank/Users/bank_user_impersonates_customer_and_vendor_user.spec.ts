...
describe("Impersonate Customer and Venodr Admin user", () => {
  before(() => {
    cy.resetDatabase();
    cy.addCompany({
      is_customer: true,
      ...
      cy.addUser({
        ...
        role: "company_admin_vendor_admin_inherited",
      });
    });
  });

  it(
    "Bank user can impersonate customer and vendor user and undo the impersonation",
    {
      retries: 5,
    },
    () => {
      ...
      // verify that we default to the companies overview page
