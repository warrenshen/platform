...
import { VendorActivePurchaseOrderStatuses } from "lib/enum";
...
const VendorPurchaseOrdersActiveTab = ({ vendorId }: Props) => {
  ...
  const { data, error } = useGetVendorPurchaseOrdersByStatusQuery({
    variables: {
      vendor_id: vendorId,
      statuses: VendorActivePurchaseOrderStatuses,
    },
  });
    ...
    <Box mt={3}>
      ...
      <Box display="flex" flexDirection="column">
        <PurchaseOrdersDataGrid
          ...
          selectablePurchaseOrderStatuses={VendorActivePurchaseOrderStatuses}
...
export default VendorPurchaseOrdersActiveTab;
