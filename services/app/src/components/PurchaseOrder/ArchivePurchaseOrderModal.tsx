...
function ArchivePurchaseOrderModal({ purchaseOrderId, handleClose }: Props) {
  ...
  const handleClickSubmit = async () => {
    snackbar.showSuccess("Purchase order archived.");
  };
      ...
      <>
          ...
          <Box mt={2} mb={6}>
            <Alert severity="warning">
              <Typography variant="body1">
                {`Warning: you are archiving a purchase order on behalf of this
        ...
        <Box mb={2}>
          <Typography variant={"h6"}>
            Are you sure you want to archive the following purchase order? You
